...
# wall
WALL_WIDTH = SCREEN_WIDTH * pow(SCALING_FACTOR, HALLWAY_DEPTH / 2) # pixels
WALL_HEIGHT = SCREEN_HEIGHT * pow(SCALING_FACTOR, HALLWAY_DEPTH / 2) # pixels
WALL_TOP_LEFT = (SCREEN_WIDTH - WALL_WIDTH) / 2, (SCREEN_HEIGHT - WALL_HEIGHT) / 2 # pixels
WALL_TOP_RIGHT = (SCREEN_WIDTH - WALL_WIDTH) / 2 + WALL_WIDTH, (SCREEN_HEIGHT - WALL_HEIGHT) / 2 # pixels
WALL_BOTTOM_LEFT = (SCREEN_WIDTH - WALL_WIDTH) / 2, (SCREEN_HEIGHT - WALL_HEIGHT) / 2 + WALL_HEIGHT # pixels
WALL_BOTTOM_RIGHT = (SCREEN_WIDTH - WALL_WIDTH) / 2 + WALL_WIDTH, (SCREEN_HEIGHT - WALL_HEIGHT) / 2 + WALL_HEIGHT # pixels

WALL_OUTLINE_TR = (SCREEN_WIDTH - WALL_WIDTH) / 2 + WALL_WIDTH + 2, (SCREEN_HEIGHT - WALL_HEIGHT) / 2 - 2 # pixels
WALL_OUTLINE_TL = (SCREEN_WIDTH - WALL_WIDTH) / 2 - 2, (SCREEN_HEIGHT - WALL_HEIGHT) / 2 - 2 # pixels
WALL_OUTLINE_BL = (SCREEN_WIDTH - WALL_WIDTH) / 2 - 2, (SCREEN_HEIGHT - WALL_HEIGHT) / 2 + WALL_HEIGHT + 2 # pixels
WALL_OUTLINE_BR = (SCREEN_WIDTH - WALL_WIDTH) / 2 + WALL_WIDTH + 2, (SCREEN_HEIGHT - WALL_HEIGHT) / 2 + WALL_HEIGHT + 2 # pixels
